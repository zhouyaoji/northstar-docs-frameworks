...
python3 "$repo_root/tools/prepare-mintlify.py"
python3 "$repo_root/tools/validate-aipp.py"
...
npm run build --prefix "$repo_root/sites/mintlify"
...
python3 "$repo_root/tools/generate-aipp.py"
